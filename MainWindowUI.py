...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.WinRate.setGeometry(QtCore.QRect(240, 380, 171, 61))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.Player.setGeometry(QtCore.QRect(120, 180, 201, 61))
        ...
        self.ThreeLandlordCards.setGeometry(QtCore.QRect(140, 0, 161, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        font.setBold(True)
        ...
        self.label.setGeometry(QtCore.QRect(120, 40, 55, 40))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.label_2.setGeometry(QtCore.QRect(190, 40, 61, 40))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.label_3.setGeometry(QtCore.QRect(280, 40, 61, 40))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.label_4.setGeometry(QtCore.QRect(30, 440, 55, 40))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.passWordCar = QtWidgets.QLineEdit(Form)
        self.passWordCar.setGeometry(QtCore.QRect(90, 450, 300, 30))
        self.passWordCar.setObjectName("passWordCar")
        self.BidWinrate = QtWidgets.QLabel(Form)
        self.BidWinrate.setGeometry(QtCore.QRect(40, 380, 171, 61))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.BidWinrate.setAlignment(QtCore.Qt.AlignCenter)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "零号"))
        self.WinRate.setText(_translate("Form", "预估胜率"))
        ...
        self.label.setText(_translate("Form", "T:10"))
        self.label_2.setText(_translate("Form", "X:小王"))
        self.label_3.setText(_translate("Form", "D:大王"))
        self.label_4.setText(_translate("Form", "卡密："))
        self.BidWinrate.setText(_translate("Form", "叫牌推荐"))
